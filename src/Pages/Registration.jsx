        ...
        <div style={MybgStyle} className="hero min-h-screen">
          ...
          <div className="hero-content flex-col">
            <div className="text-center lg:text-left">
              <h1 className="text-5xl font-bold text-white pt-20">Registrar now!</h1>
            </div>
            <div className="card sm:w-96 w-auto shadow-2xl bg-base-100">
              <form className="card-body sm:p-9 p-5  w-full">
                <div className="form-control w-full">
                <label className="label" htmlFor="name">
                    <span className="label-text">Name <span className="text-red-900">*</span></span>
                  </label>
                  <input
                    type="text"
                    id="name"
                  ...
                  <label className="label" htmlFor="image">
                    <span className="label-text">Image <span>(optional)</span></span>
                  </label>
                  <input
                    type="text"
                    id="image"
                ...
                <p className="text-sm text-headerColor capitalize">if you have a account <Link to="/login" className="text-borderColor link-hover text-base">login</Link></p>
              </form>
            </div>
          </div>
        </div>
